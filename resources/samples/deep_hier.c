...
int
Employee_getID(Employee * this)
{
    return 123;
}

int
Employee_something(Employee * this)
{
...
(void (*)())&Employee_getID, (void (*)())&Employee_something};
...
void (*Pro_vtable[]) () = {
(void (*)())&Employee_getID, (void (*)())&Employee_something, (void (*)())&Pro_getCoder};
...
main(int argc, char *argv[])
{
    ...
    pro->boss->other->number =
        (*(int (*)(Employee *))(*((*(Coder * (*)(Pro *)) (*(pro)->clazz->_vtable)[Pro_getCoder_SLOT]) (((Pro *) pro))->boss->other)->clazz->_vtable)[Employee_getID_SLOT]) (((Employee *) (*(Coder * (*)(Pro *)) (*(pro)-> clazz-> _vtable) [Pro_getCoder_SLOT]) (((Pro *) pro))->boss->other));
    printf("%d\n", pro->boss->other->number);
